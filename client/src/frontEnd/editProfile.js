   ...
   console.log(name)
    ...
    render() { 
        return <React.Fragment>
              ...
              <center>
                  <div>
                      <strong style={{marginTop:"20px",fontSize:"20px"}}>Create Profile</strong>
                   </div>
               </center>
               ...
               <div className={this.state.divRow}>
                   <div className={this.state.segDiv} id ={styles.segDiv}>
                       <div id={styles.designDiv}>           
                               ...
                               <div className="my-3" style={{width:"150px",height:"150px",borderRadius:"50%"}}>
                              <center>
                                   ...
                                   <input onChange={this.myChangeHandler} required className={this.state.inputClass} id={styles.inputStyles} type="text" name="displayName" placeholder="Display Name"/>
                                   <input onChange={this.myChangeHandler}  required className={this.state.inputClass} id={styles.inputStyles} type="text" name="fullname" placeholder="Fullname"/>
                                   <input onChange={this.myChangeHandler}  required className={this.state.inputClass} id={styles.inputStyles} type="text" name="email" placeholder="Email"/>
                   ...
                   <div id={styles.designDiv}> 
                       ...
                       <textarea onChange={this.myChangeHandler}  required className={this.state.inputClass} style={{borderRadius:"10px",height:"150px",width:"100%"}} name="status" placeholder="Status"/>
                       <span>{this.state.statusCount}/100</span>
                       <input onChange={this.myChangeHandler}  required className={this.state.inputClass} id={styles.inputStyles} type="text" name="occupation" placeholder="Occupation"/>
                       <div  id={styles.err} ><i style={{color:this.state.colorChanges}}>{this.state.err}</i></div>
